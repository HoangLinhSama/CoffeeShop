...
class UpdateStateLoginRepositoryTest {
    ...
    @Test
    fun updateStateLogIn_shouldSetLOGGEDINToTrue() = runTest {
        userSettingDataStore.edit { it[PreferenceKey.LOGGED_IN] = false }

        repository.updateStateLogIn()

        val preferences = userSettingDataStore.data.first()
        assertTrue(preferences[PreferenceKey.LOGGED_IN] == true)
    }
}